...
class FuncionariosController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Funcionarios']))
		{
                    ...
                    $usuarios->data_cadastro = $model->data_cadastro;
                    $usuarios->hora_cadastro = $model->hora_cadastro;
                    $usuarios->idfuncionarios = $model->idfuncionarios;
                    
                    if($usuarios->save()) {
 			
				$this->redirect(array('view','id'=>$model->idfuncionarios));
                    }
                    }
	}
